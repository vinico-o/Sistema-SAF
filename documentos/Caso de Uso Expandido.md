...
| **Tipo**: |Primário |
| **Descrição**: | As funções disponibilizadas são: Cadastro de Usuário, Buscar Usuário e Exclusão de Usuário. As funções de Cadastro e Exclusão de Usuário são registradas no Histórico de Auditoria de Registro. |
...
| **Tipo**: |Primário |
| **Descrição**: | As funções disponibilizadas são: Cadastro de Clube, Listagem de Clubes, Alterar informações do Clube e Exclusão de Clube. As funções de Cadastro e Exclusão de Clube são registradas no Histórico de Auditoria de Registro. A Alteração de Informações de Clube é registrada no Histórico de Auditoria de Alteração. |
...
| **Tipo**: |Primário |
| **Descrição**: | As funções disponibilizadas são: Cadastro de Despesa, Buscar Despesa, Alteração de Informações de Despesa, Listagem de Despesas e Exclusão de Despesa. As funções de Cadastro e Exclusão de Despesa são registradas no Histórico de Auditoria de Registro. A Alteração de Informações de Despesa é registrada no Histórico de Auditoria de Alteração. |
