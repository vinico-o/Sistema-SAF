...
CREATE TABLE IF NOT EXISTS jogador (id_jogador INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT NOT NULL, data_de_nascimento TEXT NOT NULL, nacionalidade TEXT NOT NULL, posicao TEXT NOT NULL, numero_da_camisa INTEGER NOT NULL UNIQUE, salario REAL NOT NULL, tempo_de_contrato INTEGER NOT NULL, valor REAL NOT NULL, idClube INTEGER, FOREIGN KEY (idClube) REFERENCES clube(id_clube));
...
INSERT INTO jogador (nome, data_de_nascimento, nacionalidade, posicao, numero_da_camisa, salario, tempo_de_contrato, valor, idClube) VALUES 
('Lucas Perri', strftime('%s', '1997-12-10') * 1000, 'Brasileira', 'Goleiro', 12, 150000.0, 36, 5000000.0, 1),
('Gatito Fernández', strftime('%s', '1988-06-01') * 1000, 'Paraguaia', 'Goleiro', 1, 200000.0, 12, 1000000.0, 1),
('Adryelson', strftime('%s', '1998-03-23') * 1000, 'Brasileira', 'Zagueiro', 4, 180000.0, 48, 8000000.0, 1),
('Victor Cuesta', strftime('%s', '1988-11-19') * 1000, 'Argentina', 'Zagueiro', 15, 300000.0, 24, 2000000.0, 1),
('Marçal', strftime('%s', '1989-02-19') * 1000, 'Brasileira', 'Lateral Esquerdo', 21, 350000.0, 24, 3000000.0, 1),
('Di Placido', strftime('%s', '1994-01-28') * 1000, 'Argentina', 'Lateral Direito', 24, 150000.0, 12, 1500000.0, 1),
('Marlon Freitas', strftime('%s', '1995-03-27') * 1000, 'Brasileira', 'Volante', 17, 250000.0, 36, 4000000.0, 1),
('Tchê Tchê', strftime('%s', '1992-08-30') * 1000, 'Brasileira', 'Volante', 6, 400000.0, 24, 3000000.0, 1),
('Eduardo', strftime('%s', '1989-10-17') * 1000, 'Brasileira', 'Meia', 33, 450000.0, 24, 2500000.0, 1),
('Victor Sá', strftime('%s', '1994-03-27') * 1000, 'Brasileira', 'Atacante', 7, 300000.0, 36, 3500000.0, 1),
('Tiquinho Soares', strftime('%s', '1991-01-17') * 1000, 'Brasileira', 'Atacante', 9, 600000.0, 24, 6000000.0, 1);

-- Jogadores Cruzeiro
INSERT INTO jogador (nome, data_de_nascimento, nacionalidade, posicao, numero_da_camisa, salario, tempo_de_contrato, valor, idClube) VALUES 
('Rafael Cabral', strftime('%s', '1990-05-20') * 1000, 'Brasileira', 'Goleiro', 101, 200000.0, 24, 1500000.0, 2),
('Matheus Pereira', strftime('%s', '1996-05-05') * 1000, 'Brasileira', 'Meia', 110, 500000.0, 36, 10000000.0, 2),
('Arthur Gomes', strftime('%s', '1998-07-03') * 1000, 'Brasileira', 'Atacante', 111, 250000.0, 48, 5000000.0, 2);
